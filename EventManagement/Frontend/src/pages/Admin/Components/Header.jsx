...
import { adminQuickStats } from './adminConstants'; // Adjust path as needed
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="relative" ref={menuRef}>
                ...
                >
                  <div className="w-8 h-8 bg-gradient-to-r from-red-600 to-rose-500 rounded-lg flex items-center justify-center">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 red-500 focus:border-transparent"
